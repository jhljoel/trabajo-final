...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_titulo.setText("PARA LA TIENDA DE INSTRUMENTOS MUSICALES \"UNIVERSO MUSICAL\"");
        getContentPane().add(jLabel_titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, -1, -1));

        jLabel_usuario.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel_usuario.setText("Usuario:");
        getContentPane().add(jLabel_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, -1, -1));

        jLabel_password.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel_password.setText("Contraseña");
        getContentPane().add(jLabel_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, -1, -1));
        ...
        getContentPane().add(jTextField_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 162, 39));
        getContentPane().add(jPasswordField_pswd, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 240, 162, 41));
        ...
        getContentPane().add(jButton_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 330, 131, 35));

        jLabel_titulo1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
